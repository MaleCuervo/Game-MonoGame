    ...
    public class GameState : State
    {
            ...
            _sprites = new List<Sprite>()
      {
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            foreach (var player in _players)
            {
                spriteBatch.DrawString(_font, "Jugador: " + player.Score.PlayerName, new Vector2(x, 10f), Color.Black);
                spriteBatch.DrawString(_font, "Salud del jugador: " + player.Health, new Vector2(x, 30f), Color.Black);
                spriteBatch.DrawString(_font, "Puntuacion: " + player.Score.Value, new Vector2(x, 50f), Color.Black);
